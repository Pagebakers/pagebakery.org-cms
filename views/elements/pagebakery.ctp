    ...
    <div class="pb-layout-east">
        ...
        <div class="pb-panel-body">       
            <ul id="pb-elements-toolbar">
                <li class="pb-element"><a href="#2" class="pb-element-html">HTML</a></li>
                <li class="pb-element"><a href="#1" class="pb-element-text">Text</a></li>
                <li class="pb-element"><a href="#3" class="pb-element-image">Image</a></li>
